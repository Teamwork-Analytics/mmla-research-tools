...
def generate_visualization_with_audio_data(simulation_id: str, data_dir):
    ...
    observation_data,2023)
    handover_finish_time, secondary_nurses_enter_time, doctor_enter_time=process_observation_timestamps(data_dir,
                                   handover_finish_time,
                                   secondary_nurses_enter_time,
                                   doctor_enter_time)
    _run_auto_transcription_coding(data_dir,simulation_id,handover_finish_time,secondary_nurses_enter_time,doctor_enter_time)
